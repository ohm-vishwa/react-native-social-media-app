...
const Login = () => {
  ...
  const onForgetPassword = async () => {
    Alert.alert(
      "Apology",
      "Currently, The 'Forgot Password' feature has not yet been implemented. we apologize for any inconvenience.",
      [
        {
          text: "Cancel",
    ...
    const visitGithub = async () => {
      await Linking.openURL(
        "https://github.com/ohm-vishwa/react-native-social-media-app"
      );
    };
  };
